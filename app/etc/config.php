...
Disallow: /*SID=
            ...
            'general' => [
                ...
                'region' => [
                    'display_all' => '1',
                    'state_required' => 'AU,BG,BR,CA,CH,CN,CO,EE,ES,HR,IN,IT,LT,LV,MX,PL,RO,US',
                ],
            ],
            'theme' => [
                'customization' => [
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'payment' => [
                ...
                'braintree' => [
                    ...
                    'privateInfoKeys' => 'avsPostalCodeResponseCode,avsStreetAddressResponseCode,cvvResponseCode,processorAuthorizationCode,processorResponseCode,processorResponseText,liabilityShifted,liabilityShiftPossible,riskDataId,riskDataDecision,transactionSource',
            ...
            'connector_dynamic_content' => [
                ...
                'external_dynamic_content_urls' => [
                    'passcode' => 'GZDQ147vg0nEnUh4yOGvLFk7grCJbOSE',
            ...
            'connector_developer_settings' => [
                ...
                'system_alerts' => [
                    ...
                    'user_roles' => '1',
                    'frequency' => '24',
                    'email_notification_template' => 'system_alert_email_template',
                ],
            ],
            ...
            'yotpo' => [
                ...
                'sync_settings' => [
                    ...
                    'orders_sync_start_date' => '2023-03-21',
                ],
                'module_info' => [
                    'yotpo_installation_date' => '2023-03-21',
                ],
            ],
            ...
            'twofactorauth' => [
                'duo' => [
                    'application_key' => 'cWRbrTEqfpuHapp195fjykwOiUebK7XmfHRTWS7Ra4V3UbC0qhfy8HjiS6dF5hD2',
                ],
            ],
        ],
        'stores' => [
        ...
        'website' => [
            'admin' => [
                'connector_configuration' => [
                    ...
                    'catalog_sync' => [
                        'catalog_type' => 'simple,virtual,downloadable,configurable,grouped,bundle',
